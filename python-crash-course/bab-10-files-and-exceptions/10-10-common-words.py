...
# You can use the count() method to find out how many times 
# a word or phrase appears in a string. 
# For example, the following code counts the number of times 'row' 
# appers in a string:
