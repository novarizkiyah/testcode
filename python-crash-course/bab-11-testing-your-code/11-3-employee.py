...
# Write a method called give_raise() that adds $5000 to the annual salary 
...
# Write your tests once without using a fixture, 
# and make sure they both pass. 
# Then write a fixture so you don’t have to create a new employee instance
